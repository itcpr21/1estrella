...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfquan = new javax.swing.JSpinner();
        ...
        tfquan.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tfname)
                    .addComponent(tfquan, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
...
productMani m = new productMani();
mainframe mf = new mainframe();
String sname = tfname.getText();
String squan = tfquan.getValue().toString();
String sprice = tfprice.getValue().toString();
int s = Integer.parseInt(squan);
double f = Double.parseDouble(sprice);
m.rps(sname, s, f);
mf.reload();
...
mf.setVisible(true);
    ...
    private javax.swing.JSpinner tfquan;
